...
export default function WhyUs() {
  ...
  return (
    <section id="why-us" ref={sectionRef} className="py-16 bg-secondary/30 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Single clean grid — 4 cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 reveal-stagger">
          {reasons.map(({ Icon, title, desc, color }) => (
            <div
              key={title}
              className="reveal glass-card rounded-3xl p-8 text-center group hover:scale-105 hover:-translate-y-1 transition-all duration-300"
            >
              <div
        ...
        <div className="mt-16 reveal">
          <div className="relative overflow-hidden rounded-3xl bg-brand-gradient p-10 text-center shadow-2xl shadow-orange-300/30 dark:shadow-orange-900/30">
            ...
            <div className="relative z-10">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-white text-[#ff6b00] font-bold text-base hover:bg-orange-50 active:scale-95 transition-all duration-200 shadow-lg"
              >
